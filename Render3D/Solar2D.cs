...
public class Solar2D : Game
{
    ...
    public Solar2D()
    {
        ...
        _sun = new TriangleObj(new SolarObject(3329400, new Vector3(0, 0, 0)), GraphicsDevice, Color.Yellow);
        _earth = new TriangleObj(new SolarObject(10, new Vector3(0, 5, 0)), GraphicsDevice, Color.Blue);
    }
